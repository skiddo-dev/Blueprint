...
export type JournalSource = 'manual' | 'invoice' | 'payment' | 'bill' | 'bill-payment' | 'closing' | 'credit-memo' | 'vendor-credit' | 'expense' | 'sales-tax-remittance' | 'deposit' | 'depreciation' | 'disposal'
