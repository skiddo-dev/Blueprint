...
const ICONS = {
  ...
  // Painter's palette with thumb notch + three paint wells: the design system.
  palette: '<path d="M12 3.75c-4.7 0-8.5 3.7-8.5 8.25s3.8 8.25 8.5 8.25c1.25 0 2.1-.8 2.1-1.85 0-.55-.25-.95-.6-1.4-.35-.45-.55-.8-.55-1.25 0-1.1.9-1.95 2-1.95h2.05c2.2 0 3.5-1.4 3.5-3.4 0-3.8-3.8-6.65-8.5-6.65Z"/><path d="M7.4 10.55h.01"/><path d="M11 7.5h.01"/><path d="M15.3 8.4h.01"/>',
  ...
  /* ── Card chips & content ───────────────────────────────────────── */
  mail: '<rect x="3.5" y="5.25" width="17" height="13.5" rx="2"/><path d="m4.25 7.5 7.75 5.4 7.75-5.4"/>',
  calendar: '<rect x="4.25" y="5.75" width="15.5" height="14.5" rx="2"/><path d="M8.5 3.5v4"/><path d="M15.5 3.5v4"/><path d="M4.25 10.25h15.5"/>',
  checklist: '<rect x="4.25" y="4.25" width="15.5" height="15.5" rx="2.5"/><path d="m8.5 12.2 2.4 2.4 4.6-5"/>',
  note: '<rect x="4.5" y="4" width="15" height="16" rx="2"/><path d="M8.25 9h7.5"/><path d="M8.25 12.5h7.5"/><path d="M8.25 16h4.5"/>',
  attachment: '<path d="m19.25 11.6-7.3 7.3a4.6 4.6 0 0 1-6.5-6.5l8-7.95a3.1 3.1 0 0 1 4.38 4.38l-7.95 7.9a1.55 1.55 0 0 1-2.2-2.2l7.35-7.3"/>',
  comment: '<path d="M19.75 14.5a1.75 1.75 0 0 1-1.75 1.75H8.5L4.25 20.5V6.25A1.75 1.75 0 0 1 6 4.5h12a1.75 1.75 0 0 1 1.75 1.75Z"/>',
  pin: '<path d="M12 21c-4.5-3.53-6.75-6.99-6.75-10.4a6.75 6.75 0 0 1 13.5 0c0 3.41-2.25 6.87-6.75 10.4Z"/><circle cx="12" cy="10.4" r="2.4"/>',
  // Chain link: share / copy-link affordances.
  link: '<path d="M10.1 13.9a4.5 4.5 0 0 0 6.36 0l3.2-3.2a4.5 4.5 0 0 0-6.36-6.36l-1.8 1.8"/><path d="M13.9 10.1a4.5 4.5 0 0 0-6.36 0l-3.2 3.2a4.5 4.5 0 0 0 6.36 6.36l1.8-1.8"/>',
  // Same drawing as `quote` — a tag is a tag; semantic name kept separate.
  tag: '<path d="M13.1 3.5H19A1.5 1.5 0 0 1 20.5 5v5.9a1.5 1.5 0 0 1-.44 1.06l-8.1 8.1a1.5 1.5 0 0 1-2.12 0l-5.9-5.9a1.5 1.5 0 0 1 0-2.12l8.1-8.1a1.5 1.5 0 0 1 1.06-.44Z"/><circle cx="16.25" cy="7.75" r="1.1"/>',
  archive: '<rect x="3.5" y="4.25" width="17" height="4.5" rx="1.25"/><path d="M5.25 8.75v9.25a2 2 0 0 0 2 2h9.5a2 2 0 0 0 2-2V8.75"/><path d="M9.9 12.75h4.2"/>',
  download: '<path d="M12 3.75v10.25"/><path d="m8.25 10.25 3.75 3.75 3.75-3.75"/><path d="M4.75 20.25h14.5"/>',
  // Activity feed kinds (CardDetailSheet).
  spark: '<path d="M12 4.25 13.9 9.6l5.35 1.9-5.35 1.9L12 18.75 10.1 13.4 4.75 11.5l5.35-1.9Z"/>',
  wrench: '<path d="M14.55 6.35a.95.95 0 0 0 0 1.35l1.75 1.75a.95.95 0 0 0 1.35 0l3.1-3.1a5.6 5.6 0 0 1-7.4 7.4l-6.7 6.7a2 2 0 0 1-2.83-2.83l6.7-6.7a5.6 5.6 0 0 1 7.4-7.4Z"/>',
  hourglass: '<path d="M6.25 3.5h11.5"/><path d="M6.25 20.5h11.5"/><path d="M7.75 3.5v3.1c0 2.1 1.7 3.4 4.25 5.4 2.55-2 4.25-3.3 4.25-5.4V3.5"/><path d="M7.75 20.5v-3.1c0-2.1 1.7-3.4 4.25-5.4 2.55 2 4.25 3.3 4.25 5.4v3.1"/>',
  signal: '<path d="M12 18.6h.01"/><path d="M8.6 15.2a4.8 4.8 0 0 1 6.8 0"/><path d="M5.75 12.35a8.85 8.85 0 0 1 12.5 0"/><path d="M3.5 9.5a12 12 0 0 1 17 0"/>',

  /* ── Accounting pages ───────────────────────────────────────────── */
  scales: '<path d="M12 4.5v16"/><path d="M8.25 20.5h7.5"/><path d="M4.5 7h15"/><path d="m4.5 7-2.3 5.75c.67.5 1.48.75 2.3.75s1.63-.25 2.3-.75L4.5 7Z"/><path d="m19.5 7-2.3 5.75c.67.5 1.48.75 2.3.75s1.63-.25 2.3-.75L19.5 7Z"/>',
  printer: '<path d="M7 7V3.75h10V7"/><rect x="3.75" y="7" width="16.5" height="8.5" rx="2"/><path d="M7 12.25h10v8.25H7Z"/><path d="M17 10h.01"/>',
  camera: '<path d="M8.75 6.5 10 4.5h4l1.25 2h3A1.75 1.75 0 0 1 20 8.25v9A1.75 1.75 0 0 1 18.25 19H5.75A1.75 1.75 0 0 1 4 17.25v-9A1.75 1.75 0 0 1 5.75 6.5Z"/><circle cx="12" cy="12.5" r="3.4"/>',
  lock: '<rect x="5" y="10.75" width="14" height="9.75" rx="2"/><path d="M8.25 10.75V7.5a3.75 3.75 0 0 1 7.5 0v3.25"/><path d="M12 14.5v2.25"/>',
  unlock: '<rect x="5" y="10.75" width="14" height="9.75" rx="2"/><path d="M8.25 10.75V7.5a3.75 3.75 0 0 1 7.35-1.05"/><path d="M12 14.5v2.25"/>',
