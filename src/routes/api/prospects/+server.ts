...
import { hasLiveSource } from '$lib/server/prospects-source'
...
// (prospects + map center/defaults + whether results are the live OSM/GIS source
// vs mock), so a native client can render the list and the map. Pipeline-field
// edits go through PATCH /api/prospects/[id].
