...
import { recordBillPayment } from '$lib/server/payables'
import { parseMoney } from '$lib/money'

// Admin-only. Record a payment we made against a bill. recordBillPayment reduces
// the bill balance, advances its status, and posts Dr A/P / Cr Cash in one
// transaction; an over-payment or void bill → 400.
