...
const SECTIONS = [
  ...
  ['Board cards & filters', 'TaskCard / detail sheet / FilterBar / StoreLanes — the chips and controls on every card (second pass; card-level).', [
    ['Source: email', '📩', 'mail'],
    ['Source: manual', '✏️', 'pencil'],
    ['Assignee chip', '👤', 'person'],
    ['Co-assignees', '👥', 'users'],
    ['Due / created dates', '📅 🗓', 'calendar'],
    ['Aging (days in column)', '⏳', 'hourglass'],
    ['Quote amount', '💰', 'quote'],
    ['PO chip', '🧾', 'bill'],
    ['Inbox chip', '📥', 'import'],
    ['Checklist', '☑', 'checklist'],
    ...
    ['Comments', '💬', 'comment'],
    ['Full email panel', '📄', 'mail'],
    ['Store lane / filter', '📍', 'pin'],
    ['No-store lane', '🏷', 'tag'],
    ['Archived view', '🗄', 'archive'],
    ['Download file', '⬇️', 'download'],
    ['Offline banner', '📡', 'signal'],
    ['Activity: created', '✨', 'spark'],
    ['Activity: system', '🛠️', 'wrench'],
  ]],
  ['Accounting pages — tiles & actions', 'Reports hub tiles, the overview quick actions, and the shared page controls (third pass).', [
    ['Income statement', '📊', 'reports'],
    ['Balance sheet', '🏦', 'scales'],
    ['Cash flow', '💵', 'spend'],
    ['P&L by month', '📅', 'calendar'],
    ['Job profitability', '🏗️', 'vendors'],
    ['General ledger', '📚', 'ledger'],
    ['Journal', '🧾', 'list'],
    ['1099 payments', '📋', 'po'],
    ['Budget vs actual', '🎯', 'budget'],
    ['New invoice / recurring type', '📄', 'invoice'],
    ['Record expense', '💸', 'spend'],
    ['Books locked', '🔒', 'lock'],
    ['Books open', '🔓', 'unlock'],
    ['Print report', '🖨', 'printer'],
    ['Scan receipt (AI)', '📷', 'camera'],
    ['Make this recurring', '🔁', 'recurring'],
  ]],
