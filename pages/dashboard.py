...
<style>
    ...
    .stMetric > div > div {
        color: #ff4b4b !important;  /* Red for metrics */
    }
</style>
""", unsafe_allow_html=True)

st.title("📊 Blueprint Task Dashboard")
st.caption("View and analyze raw task data with enhanced colorful quote analytics")
...
with st.sidebar:
    ...
    st.subheader("📊 Stats")
    tasks = get_tasks()
    # Show stats for ALL Kanban statuses with color indicators
    for status in ["To Do", "In Progress", "Review", "Approval", "Done", "On Hold", "Cancelled"]:
...
if not tasks:
    ...
    # Enhanced quote analytics section with more colors
    st.divider()
    st.subheader("💰 Quote Analytics Dashboard")
    
    # Summary statistics with colored containers
    ...
    # Charts section - 2x2 grid for better organization with enhanced colors
    chart_row1_col1, chart_row1_col2 = st.columns(2)
    chart_row2_col1, chart_row2_col2 = st.columns(2)
    
    with chart_row1_col1:
        # Quote Value by Type - Multi-colored bar chart using multiple columns
        st.write("**💰 Total Quote Value by Type**")
        quote_type_data = df.groupby('quote_type')['quote_value'].sum()
        # Convert to DataFrame with one row (each column = quote type) for multi-color bars
        quote_type_df = quote_type_data.to_frame().T
        st.bar_chart(quote_type_df)
        
    with chart_row1_col2:
        # Task Count by Quote Type - Multi-colored bar chart
    ...
    with chart_row2_col1:
        # Quote Value Trend Over Time by Quote Type - Multi-colored line chart
    ...
    with chart_row2_col2:
        # Top Assignees by Quote Value - Multi-colored bar chart
    ...
    # Additional insights section with more colors
    st.divider()
    ...
    with insight_row1_col1:
        # Average Quote by Status - Multi-colored bar chart
    ...
    with insight_row1_col2:
        # Quote Assignee Popularity - Multi-colored bar chart
    ...
    with insight_row2_col1:
        # Quote Value Distribution - Multi-colored bar chart
    ...
    with insight_row2_col2:
        # Status Distribution - Pie chart alternative with colors
    ...
    # Download button for CSV with colored container
    st.divider()
